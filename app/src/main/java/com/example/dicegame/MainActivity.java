...
public class MainActivity extends AppCompatActivity {
	...
	public void onRoll(View view) {
		...
		if(checkToastConditions()==1) Toast.makeText(this, "Two Of A Kind!", Toast.LENGTH_SHORT).show();
		if(checkToastConditions()==2) Toast.makeText(this, "Three Of A Kind!", Toast.LENGTH_SHORT).show();
	}
